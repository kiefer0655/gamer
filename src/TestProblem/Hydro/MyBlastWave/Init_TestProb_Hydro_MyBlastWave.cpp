...
bool Flag_MyBlastWave( const int i, const int j, const int k, const int lv, const int PID, const double *Threshold );
#ifdef MHD
double MHD_ResetByUser_VecPot_MyBlastWave( const double x, const double y, const double z, const double Time,
                                         const double dt, const int lv, const char Component, double AuxArray[] );
double MHD_ResetByUser_BField_MyBlastWave( const double x, const double y, const double z, const double Time,
...
//-------------------------------------------------------------------------------------------------------
// Function    :  Init_TestProb_Hydro_MyBlastWave
...
#  ifdef MHD
   ...
   MHD_ResetByUser_BField_Ptr    = MHD_ResetByUser_BField_MyBlastWave;
   MHD_ResetByUser_VecPot_Ptr    = (Blast_ResetB_VecPot) ? MHD_ResetByUser_VecPot_MyBlastWave : NULL;
#  endif
   Flag_User_Ptr                 = Flag_MyBlastWave;
#  ifdef SUPPORT_HDF5
